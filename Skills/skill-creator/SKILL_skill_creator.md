...
> [!IMPORTANT]
> **Project Constraint**: sourmate project uses `src/proxy.ts` instead of `middleware.ts`. When creating skills that involve routing or edge logic, explicitly instruct users/agents to use `proxy.ts`.
